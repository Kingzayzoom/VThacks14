...
Dependencies: Next.js and React (MIT), Zod (MIT), Lucide icons (ISC), TypeScript (Apache-2.0), Playwright (Apache-2.0), axe-core (MPL-2.0), Fontsource distribution of Cormorant Garamond, Geist and IBM Plex Mono (SIL Open Font License). Package versions and transitive licenses are available in package-lock.json and installed package license files.

Implementation reference: [Next.js App Router installation](https://nextjs.org/docs/app/getting-started/installation), checked for the installed 16.3.5 version. Fonts are self-hosted from packages. Provider research provenance and limitations remain in docs/RESEARCH_NOTES.md.
